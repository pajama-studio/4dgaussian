...
const html = '<!doctype html>\n<html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">' +
  ...
  '<script type="module" src="/math/math.js"></script><script type="module" src="/math/trace-ui.mjs"></script><script type="module" src="/math/sh-ui.mjs"></script><script type="module" src="/math/training-ui.mjs"></script><link rel="stylesheet" href="/math/training.css"><link rel="stylesheet" href="/site.css"><script type="module" src="/site.mjs"></script></head><body id="top">' +
